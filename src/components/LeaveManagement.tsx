...
const LeaveManagement = () => {
  ...
  React.useEffect(() => {
    employees.forEach(emp => initializeEmployeeBalance(emp.id));
  }, [employees, initializeEmployeeBalance]);
        ...
        return (
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              {leaveBalances.slice(0, 1).map(balance => {
                  ...
                  <Card key={balance.employeeId}>
                    ...
                    <CardContent className="space-y-2">
                      <div className="flex justify-between text-sm">
                        <span>Annual:</span>
                        <Badge variant="outline">{balance.annual} days</Badge>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span>Sick:</span>
                      ...
                      <div className="flex justify-between text-sm">
                        <span>Casual:</span>
                        <Badge variant="outline">{balance.casual} days</Badge>
                      </div>
                    </CardContent>
                  </Card>
                ) : null;
